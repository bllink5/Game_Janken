...
class TopScorePdfAdapter : RecyclerView.Adapter<TopScorePdfAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TopScorePdfAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_top_score_pdf, parent, false)
        return ViewHolder(view)
    }

    override fun getItemCount(): Int = listTopScore.size

    override fun onBindViewHolder(holder: TopScorePdfAdapter.ViewHolder, position: Int) {
